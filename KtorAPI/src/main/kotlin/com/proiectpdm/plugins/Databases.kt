...
fun Application.configureDatabases() {
    ...
    transaction(db) {
        ...
        SchemaUtils.create(UsersTable, AppointmentsTable, DiseaseCategoriesTable, DiseaseSymptomsTable, InsuranceTable)
        ...
        val categoriesWithSymptoms = mapOf(
            "Probleme Respiratorii" to listOf(
                ...
                "Constipație",
                "Balonare",
                "Arsuri la stomac (reflux gastric)",
                "Senzație de greutate după masă",
                "Pierderea apetitului",
                "Sânge în scaun",
                "Senzație de greață fără motiv clar",
                ...
                "Respirație dificilă în poziție culcată",
                "Umflarea picioarelor sau a gleznelor",
                "Oboseală extremă la eforturi mici",
                "Puls neregulat sau slab"
                ...
                "Senzație de crampe musculare",
                "Durere după efort fizic"
                ...
                "Tremor",
                "Convulsii",
                "Slăbiciune bruscă într-o parte a corpului",
                ...
                "Roșeață",
                "Inflamație",
                "Leziuni deschise sau ulcere",
                "Piele uscată sau descuamată",
                "Căderea părului",
                "Pete pe piele (albe, maronii, roșii)",
                "Acnee severă",
                "Schimbări ale unghiilor (culoare sau structură)"
            ), "Probleme Urinare" to listOf(
                "Durere la urinare",
                "Senzație de arsură",
                "Urină cu sânge",
                "Nevoia frecventă de a urina",
                "Dificultăți în inițierea urinării",
                "Jet de urină slab sau intermitent",
                ...
                "Pierderea auzului",
                "Senzație de zgomot în urechi (tinitus)",
                ...
                "Probleme legate de libido"
            )
        )

        categoriesWithSymptoms.forEach { (categoryName, symptoms) ->
            val categoryId = DiseaseCategoriesTable.insert {
                it[name] = categoryName
            } get DiseaseCategoriesTable.id

            symptoms.forEach { symptomName ->
                DiseaseSymptomsTable.insert {
                    it[name] = symptomName
                    it[DiseaseSymptomsTable.categoryId] = categoryId
                }
            }
        }
    }
